"""
Django settings for SmallJobs project.
...
SECRET_KEY = "django-insecure-ses12l!*+ex_h9hyzeu#!^ei)59!f8r48*aty$&f2-9=j%zzci"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "SmallJobsHome", "web_pages")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "SmallJobs.wsgi.application"
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgresql://localhost:5432/postgres")
}
...
AUTH_USER_MODEL = "SmallJobsHome.SmallJobsUser"
...
ASGI_APPLICATION = "SmallJobs.asgi.application"
